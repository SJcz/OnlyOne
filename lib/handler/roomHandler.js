...
class RoomHandler {
    ...
    joinRoom({ roomName }, session) {
        ...
        this.app.redisService.publish('channel', {route: 'joinRoom', data: {roomName, userId: session.userId}});
    ...
    leaveRoom({ roomName }, session) {
        ...
        this.app.redisService.publish('channel', {route: 'leaveRoom', data: {roomName, userId: session.userId}});
        return 'ok';
    }
